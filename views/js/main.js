...
Updates:
ss01:  Scott Stubbs 10/10/2015 - replaced the pizza resize fucntion to remove 
        the Forced Sync Layout issue
ss02:  Scott Stubbs 10/17/2015 - make some additional udpates per the reviers
        comments */
  ...
  switch(x) {
    ...
    case "whimsical": 
      var whimsy = ["whimsical", "silly", "drunken", "goofy", "funny", "weird",
            ...
            "hilarious", "conceited", "happy", "comical", "curious", "peculiar",
             ...
             "sleepy", "cockeyed", "dizzy", "dancing", "absurd", "laughing", 
             "hairy", "smiling", "perplexed", "baffled", "cockamamie", "vulgar",
    ...
    case "praise":
      var praise = ["beautiful", "intelligent", "smart", "genius", "ingenious", 
            ...
            "marvelous", "dazzling", "cute", "charming", "attractive", "nifty",
            "delightful", "superior", "amiable", "gentle", "heroic", 
            "courageous", "valiant", "brave", "noble", "daring", "fearless",
            "gallant", "adventurous", "cool", "enthusiastic", "fierce",
            "awesome", "radical", "tubular", "fearsome", "majestic", "grand",
            "stunning"];
      return praise;
    case "scientific":
    ...
    default:
      var scientific_default = ["scientific", "technical", "digital",
          ...
          "mechanical", "technological", "innovative", "brainy", "chemical",
          "quantum", "astro", "space", "theoretical", "atomic", "electronic",
  ...
  switch(y) {
    case "animals": 
      var animals = ["flamingo", "hedgehog", "owl", "elephant", "pussycat",
          ...
          "parakeet", "hamster", "gerbil", "squirrel", "rat", "dove", "toucan", 
    ...
    case "music":
      var music = ["violin", "flute", "bagpipe", "guitar", "symphony", 
          ...
          "saxophone", "bugle", "trumpet", "sousaphone", "cornet", 
    ...
    case "jewelry":
      var jewelry = ["earrings", "ring", "necklace", "pendant", "choker", 
          ...
          "jewelry", "anklet", "bangle", "locket", "finery", "crown", "tiara",
    ...
    default:
      var scifi_default = ["robot", "alien", "raygun", "spaceship", "UFO", 
          ...
          "jupiter", "saturn", "mars", "quasar", "blackHole", "warpDrive",
          "laser", "orbit", "gears", "molecule", "electron", "neutrino", 
          "proton", "experiment", "photon", "apparatus", "universe", 
          "gravity", "darkMatter", "constellation", "circuit", "asteroid"];
      return scifi_default;
  } 
}

var adjectives = ["dark", "color", "whimsical", "shiny", "noise", 
      "apocalyptic", "insulting", "praise", "scientific"];  // types of 
          //adjectives for pizza titles
var nouns = ["animals", "everyday", "fantasy", "gross", "horror",
      "jewelry", "places", "scifi"];  // types of nouns for pizza titles

// Generates random numbers for getAdj and getNoun functions and returns 
      // a new pizza name
...
var pizzaElementGenerator = function(i) {
  var pizzaContainer,             // contains pizza title, image and list 
        // of ingredients
      pizzaImageContainer,        // contains the pizza image
      pizzaImage,                 // the pizza image itself
      pizzaDescriptionContainer,  // contains the pizza title and list of 
            // ingredients
...
==================  ss01 */
  ...
  function changePizzaSizes(size) {
    ...
    // ss01 use this simple method of getting the size percentage instead of 
        // calling the determineDx and sizeSwitcher
    switch(size) {
      case "1":
        newWidth = 25;
        break;
    ...
    // ss02 use this selctor instead becasue it is faster. 
    var randomPizzas = document.getElementsByClassName(".mover");  
    for (var i = 0; i < randomPizzas.length; i++) {
      //randomPizzas[i].style.width = sizeSwitcher(size) * 100 + "%"; 
      // the pizzas will be scaled to the new width
...
// This for-loop actually creates and appends all of the pizzas when the page 
    //loads
for (var i = 2; i < 100; i++) {
...
// The following code for sliding background pizzas was pulled from Ilya's 
    //demo found at:
// https://www.igvita.com/slides/2012/devtools-tips-and-tricks/jank-demo.html

// Moves the sliding background pizzas based on scroll position
/* ss01 - moved the reference to the document.body outside of the for loop */
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");
  // ss02change to getElementsByClassName
  var items = document.querySelectorAll('.mover');
  // var items = document.getElementsByClassName('.mover');
  var scrollTop = (document.body.scrollTop / 1250);  // ss01 make this 
      //calculation before the loop
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    // ss01 use the webkitTransform instead
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var cols = 8;
  var s = 256;
  var numPizzas = Math.floor(screenHeight / s) * cols; //ss01 reduce the number 
      //of pizzas painted on the screen - you can't see all 200 of them 
  for (var i = 0; i < numPizzas; i++) { 
    ...
    elem.basicLeft = (i % cols) * s - (cols * 128); //ss02 this adjust the 
        // starting position of the pizzas to the left
    elem.style.top = (Math.floor(i / cols) * s) + 'px';
    document.querySelector("#movingPizzas1").appendChild(elem);
    //document.getElementById("movingPizzas1").appendChild(elem); 
        // ss01 getElementById is faster
  }
  updatePositions();
});
